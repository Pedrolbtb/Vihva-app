...
import com.companyvihva.vihva.Inicio.Perfil_medico.Descrição_addmedico
...
class Adapter_addMedico(
    private val context: Context,
    private val listaAmizades: MutableList<Amigos>
) : RecyclerView.Adapter<Adapter_addMedico.AmigosViewHolder>() {
    ...
    inner class AmigosViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            itemView.setOnClickListener {
                ...
                val intent = Intent(context, Descrição_addmedico::class.java).apply {
